...
createrepo /repos/rhel-ha-for-rhel-7-server-rpms/ -o /repos/rhel-ha-for-rhel-6-server-rpms
createrepo /repos/rhel-rs-for-rhel-7-server-rpms/ -o /repos/rhel-rs-for-rhel-6-server-rpms